...
- High-quality fabric textures from the `textures/` folder
...
This script requires a specific Python environment with external packages to work correctly.

Please make sure to **activate the environment described in the main page of this repository** before running this script.
...
This code is adapted from the original repository:  
